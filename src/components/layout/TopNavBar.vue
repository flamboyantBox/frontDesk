        ...
        >
          <strong>
            ...
            <font size="3" style="color: black">
              :欢迎您的到来！ 如有出现BUG情况可联系博主 QQ：
              <font style="color:#FF0000;">2227439286</font>
            </font>
          </strong>
        </marquee>
      </div>
        ...
        <div class="float-right nav-title">
            ...
            <ul class="menus-submenu">
              ...
              <li>
                <router-link to="/categories">
                  <svg-icon icon-class="categories"/> 分类
                </router-link>
              </li>
              <li>
                <router-link to="/tags">
            ...
            <ul class="menus-submenu">
              <li>
                <router-link to="/albums">
                  <svg-icon icon-class="album"/> 相册
                </router-link>
              </li>
              <li>
                <a href="http://www.upupoo.com/" target="_blank">
          ...
          <div class="menus-item">
            <router-link class="menu-btn" to="/siteNavigation">
              <svg-icon icon-class="siteNavigation"/> 购物车
            </router-link>
            <ul class="menus-submenu">
              <li>
                <router-link to="/reception">
                  <svg-icon icon-class="reception"/> 待收货
                </router-link>
              </li>
            </ul>
          </div>
...
export default {
  ...
  methods: {
    ...
    logout() {
      ...
      this.axios.get("/api/userAuth/core/logout", {params: {userId: this.$store.state.userId}}).then(({ data }) => {
        if (data.code === 200) {
